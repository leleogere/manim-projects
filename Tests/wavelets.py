...
# calcule les coefficients dans l'espace d'approximation
...
class WaveletPsiA_no_build(WaveletEpicycles):
    def __init__(self):
        super().__init__(N=32, K=np.inf, L=None, tex_symbol="$\\Psi$",
                         show_shape=True, show_build=False, duration=40)
